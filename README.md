...
The projects here demonstrate my ability to move from **raw data → analysis → visualization → insights**, using industry-standard tools such as SQL, Excel, Power BI, and Looker Studio.
